...
- Name: screenshot.spec.js >> screenshot and visual comparission
...
Expected: visible
Error: Unsupported token "@displayed-text" while parsing css selector "@displayed-text". Did you mean to CSS.escape it?
        ...
        - banner [ref=f1e3]:
          - generic [ref=f1e6]:
            - generic [ref=f1e7]:
              ...
              - generic [ref=f1e10]: 1d 2h 33m 12s
